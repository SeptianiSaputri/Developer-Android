package id.ac.poliban.mi.va.septi.homework_073;
...
import id.ac.poliban.mi.va.septi.powerreceiverhw_073.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.mi.va.septi.powerreceiverhw_073.RANDOM_NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PowerReceiver_028");
